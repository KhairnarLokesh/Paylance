...
const Footer = () => {
    return (<footer className="bg-slate-950 text-white py-12 px-4 font-inter border-t border-slate-800 overflow-hidden relative">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
                <div className="space-y-4">
                    ...
                    <div className="flex space-x-5 pt-2">
                        <a href="https://github.com/KhairnarLokesh" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-500 transition-transform transform hover:scale-110">
                            <GitHubIcon size={28}/>
                        </a>
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                        <li>
                            <button onClick={() => document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' })} className="text-slate-400 hover:text-blue-500 transition-colors duration-300">
                                Home
                            </button>
                        </li>
                        <li>
