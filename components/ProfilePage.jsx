    ...
    return (
        <div className="max-w-6xl mx-auto pb-20">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 mb-6 px-4">
                <Home
                    className="h-4 w-4 cursor-pointer hover:text-slate-900 transition-colors"
                ...
                {user?.role === 'client' && (
                    <button
                        ...
                        className="ml-auto flex items-center gap-1.5 px-4 py-2 bg-blue-50 text-blue-700 rounded-full font-bold hover:bg-blue-100 transition-all border border-blue-200"
                    >
            ...
            <div className="bg-white rounded-[2rem] overflow-hidden shadow-sm border border-slate-100 mx-4">
                {/* Banner Section */}
                <div
                    className="relative h-64 bg-slate-100 bg-cover bg-center transition-all duration-500"
                    style={{
                ...
                >
                    ...
                    <button
                        ...
                        className="absolute top-6 right-6 p-2 bg-white/90 backdrop-blur rounded-full shadow-sm hover:bg-white transition-all hover:scale-110 active:scale-95"
                    >
                    ...
                    <div className="absolute -bottom-16 left-10">
                        <div className="relative group/avatar">
                            ...
                            <div className="h-40 w-40 rounded-full border-4 border-white overflow-hidden bg-slate-100 shadow-lg transition-transform group-hover/avatar:scale-[1.02]">
                                <img
                                    src={user?.profile_image || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=300"}
                                    alt="Profile"
                            ...
                            <button
                                ...
                                className="absolute bottom-2 right-2 p-3 bg-slate-900 rounded-full text-white shadow-xl hover:bg-slate-800 transition-all hover:scale-110 active:scale-95 z-10"
                            >
                ...
                <div className="pt-20 px-10 pb-10">
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-12">
                                    ...
                                    {isEditingName ? (
                                        <div className="flex items-center gap-2">
                                            <Input
                                                ...
                                                className="text-3xl font-extrabold h-14 w-80 rounded-xl"
                                                autoFocus
                                            />
                                        ...
                                        <>
                                            ...
                                            <button
                                                className="p-1.5 hover:bg-slate-50 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                        ...
                        <Button className="bg-slate-900 hover:bg-slate-800 text-white rounded-2xl px-8 py-7 h-auto font-bold flex items-center gap-3 shadow-xl transition-all active:scale-95 whitespace-nowrap">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-16 border-t border-slate-50 pt-16">
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center group">
                                <h3 className="text-sm font-bold text-slate-400 tracking-widest uppercase">Skills</h3>
                                <button
                            ...
                            <div className="flex flex-wrap gap-3">
                                {user?.skills && user.skills.length > 0 ? (
                                    user.skills.map((skill, idx) => (
                                        <div
                                            key={idx}
                                            className="group flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-700 font-bold text-sm rounded-xl border border-slate-100 hover:bg-white hover:border-blue-200 transition-all cursor-default"
                                        >
                                            {skill}
                                            <button
                                    ...
                                    <p className="text-slate-400 font-medium italic">Nothing to see here... yet!</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center group">
                                <h3 className="text-sm font-bold text-slate-400 tracking-widest uppercase">Current Role</h3>
                                {!isEditingRole && (
                                    <button
                                        className="p-1.5 hover:bg-slate-50 rounded-lg transition-colors text-slate-400 opacity-0 group-hover:opacity-100"
                            ...
                            {isEditingRole ? (
                                ...
                                <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100 group">
                                    <div className="p-3 bg-white rounded-xl shadow-sm">
                                        <Briefcase className="h-6 w-6 text-blue-600" />
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-400 font-bold uppercase tracking-tight mb-0.5">Title</p>
                                        <p className="text-lg font-bold text-slate-700">{tempRole}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        {user?.role === 'client' && (
                            <div className="space-y-6">
                                <div className="flex justify-between items-center">
                                    <h3 className="text-sm font-bold text-slate-400 tracking-widest uppercase">My Postings</h3>
                                    <button
                                ...
                                <div className="space-y-3">
                                    {myProjects.length > 0 ? (
                                        myProjects.slice(0, 3).map((proj) => (
                                            <div key={proj._id} className="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex justify-between items-center group/proj hover:bg-white hover:border-blue-100 transition-all">
                                                <div>
                                                    <p className="font-bold text-slate-700 group-hover/proj:text-blue-600 transition-colors">{proj.title}</p>
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center">
                                <h3 className="text-sm font-bold text-slate-400 tracking-widest uppercase">Social Handles</h3>
                            </div>
                            <div className="flex items-center gap-8">
                                <div className="group flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span className="font-bold text-slate-700 hidden group-hover:block transition-all">GitHub</span>
                                </div>
                                <div className="group flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span className="font-bold text-slate-700 hidden group-hover:block transition-all">LinkedIn</span>
                                </div>
                            </div>
                        </div>
                    </div>
