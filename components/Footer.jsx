...
const GitHubIcon = ({ size = 24, className = "" }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
const TwitterIcon = ({ size = 24, className = "" }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
const LinkedInIcon = ({ size = 24, className = "" }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
</svg>;
const Footer = () => {
    return (<footer className="bg-slate-50 text-slate-900 py-16 px-4 font-inter border-t border-slate-200 overflow-hidden relative">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
            <div className="space-y-4">
                ...
                <div className="flex space-x-5 pt-2">
                    <a href="https://github.com/KhairnarLokesh" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-600 transition-transform transform hover:scale-110">
                        <GitHubIcon size={28} />
                    </a>
                    <a href="#" className="text-slate-400 hover:text-blue-500 transition-transform transform hover:scale-110">
                        <TwitterIcon size={28} />
                    </a>
                    <a href="http://linkedin.com/in/lokesh-khairnar" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-500 transition-transform transform hover:scale-110">
            ...
            <div className="space-y-4">
                ...
                <ul className="space-y-3">
                    <li>
                        <button onClick={() => document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' })} className="text-slate-500 hover:text-blue-600 transition-colors duration-300 font-medium">
                            Home
                        </button>
                    </li>
                    <li>
                        <button onClick={() => document.getElementById('why-paylance')?.scrollIntoView({ behavior: 'smooth' })} className="text-slate-400 hover:text-blue-500 transition-colors duration-300">
                            About Us
                        </button>
                    </li>
                    <li>
                        <button onClick={() => document.getElementById('demo-projects')?.scrollIntoView({ behavior: 'smooth' })} className="text-slate-400 hover:text-blue-500 transition-colors duration-300">
                            Services
                        </button>
                    </li>
                </ul>
