...
export default function Services() {
    ...
    return (
        <section id="services" className="py-24 bg-[#0A0A0A] text-[#FAFAFA] overflow-hidden relative border-t border-[#2A2A2A]">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#161616_1px,transparent_1px),linear-gradient(to_bottom,#161616_1px,transparent_1px)] bg-[size:16px_16px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-30 pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {services.map((service, index) => (
                        <ScrollAnimation key={index} delay={index * 50} className="group p-8 rounded-2xl bg-[#111111] border border-[#2A2A2A] hover:border-[#EA580C]/40 hover:shadow-2xl hover:shadow-black/50 transition-all duration-300 hover:-translate-y-2">
