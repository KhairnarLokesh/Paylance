  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100">
      ...
      <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <button
              ...
              className="flex md:hidden p-2 text-slate-300 hover:bg-slate-800 rounded-lg transition-colors ml-2"
            >
        ...
        {/* Mobile menu content */}
        {isMenuOpen && (
          <div className="md:hidden border-t border-slate-800 bg-slate-950 absolute top-20 left-0 w-full shadow-xl z-[60] py-6 px-6 space-y-4 animate-in slide-in-from-top-2 duration-200">
            <button
              onClick={() => {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10 z-10">
              ...
              <div>
                <Button
                  size="lg"
                  className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-8 h-12 text-base font-medium group"
