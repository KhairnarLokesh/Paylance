...
export function RetroGrid({ className, children, angle = 65, cellSize = 60, opacity = 0.5, lineColor = "#4b5563", }) {
    return (<div className={cn("fixed inset-0 overflow-hidden bg-neutral-950", className)}>
      {/* Keyframe animation */}
      <style>{`
